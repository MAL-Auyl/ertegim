// Pure blocklist-matching logic, shared by lib/blocklist-cli.js (Bun CLI +
// server/server.js's import) and api/transcribe.js (Vercel Edge Function).
// Deliberately has zero Bun-specific APIs (no import.meta.main) so it can be
// imported unmodified from an Edge/ESM bundle — see lib/blocklist-cli.js for
