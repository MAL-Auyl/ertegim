...
const STORY = {
  ...
  fox_question: {
    ...
    onReask: "fox_reask",
    onReveal: "fox_reveal",
    criterion: "Правильный ответ — число три (3). Засчитывай верным любое произношение " +
      "числа три на казахском или русском («үш», «три», «3», «3 штуки» и т.п.). Всё " +
      "остальное (другое число, молчание не по теме, посторонний ответ) — неверно.",
  },
  fox_correct: {
    kind: "narration",
    speaker: "Түлкі (лисёнок)",
  ...
  owl_question: {
    ...
    onReask: "owl_reask",
    onReveal: "owl_reveal",
    criterion: "Правильный ответ — любое существующее казахское или русское слово, " +
      "фонетически похожее на «мысық» (например, оканчивается на «-ық»/«-ик», как " +
      "«қасық»). Не обязательно именно «қасық» — любая настоящая рифма/созвучие " +
      "засчитывается верной. Слово без всякого созвучия или посторонний ответ — неверно.",
  },
  owl_correct: {
    kind: "narration",
    speaker: "Үкі (совёнок)",
